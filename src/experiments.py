...
from .logical_effort import LogicalEffortPathAnalysis, analyze_path_logical_effort
from .monte_carlo import MonteCarloError, generate_variations, run_monte_carlo
from .monte_carlo_reports import (
    save_completed_monte_carlo,
    save_skipped_monte_carlo,
)
from .optimization_heuristics import OptimizationHeuristic
from .optimization_reports import save_optimization_reports
...
from .summary_report import save_final_summary
...
from .topology import save_circuit_topology
...
class Experiments:
    ...
    def _run_visualization(self, circuit: Circuit) -> None:
        ...
        from .visualization import draw_circuit_graph, timing_slack_extent
